...
```
             ...
             +-----------------------+                   +-----------------------+
                         |                                           |
                         | Teaches payload schema                    | Proxies raw HTTP
                         | & failover endpoints                      v
                         |                               +-----------------------+
                         +------------------------------>|   jblukach/geo        |
                                                         |   Geo Intelligence    |
                                                         |   (Python / MMDB)     |
...
```json
{
  ...
  "tools": {
    "list_available_endpoints": { "http_example": "GET /mcp" },
    "get_api_instructions": { "http_examples": ["GET /mcp?endpoint=geo"] }
  }
}
```
