...
![github-repository](/images/2023/08/1-github-repository.png)
...
![default-iam-role](/images/2023/08/2-default-iam-role.png)

![iam-permissions](/images/2023/08/3-iam-permissions.png)

Remember, when creating the notebook instance, the requirements for testing are much different than running in production.

![create-notebook](/images/2023/08/4-create-notebook.png)

![grant-permissions](/images/2023/08/5-grant-permissions.png)

![repositories-access](/images/2023/08/6-repositories-access.png)
