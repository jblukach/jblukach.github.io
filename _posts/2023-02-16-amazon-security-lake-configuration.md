---
layout: post
title: "4n6ir #19 - Amazon Security Lake Configuration"
author: "John Lukach"
...
[![1-security-lake-get-started.png](/images/2023/02/1-security-lake-get-started.png)](/images/2023/02/1-security-lake-get-started.png)
...
[![2-security-lake-event-sources.png](/images/2023/02/2-security-lake-event-sources.png)](/images/2023/02/2-security-lake-event-sources.png)

Security Lake does not support all regions currently compared to the Cloud Trail Lake capability. 

[![3-security-lake-selected-regions.png](/images/2023/02/3-security-lake-selected-regions.png)](/images/2023/02/3-security-lake-selected-regions.png)

Only AES encryption is supported, keeping encryption management straightforward while missing out on the benefits of KMS.

[![4-security-lake-iam-encryption.png](/images/2023/02/4-security-lake-iam-encryption.png)](/images/2023/02/4-security-lake-iam-encryption.png)
...
[![5-security-lake-selected-accounts.png](/images/2023/02/5-security-lake-selected-accounts.png)](/images/2023/02/5-security-lake-selected-accounts.png)
...
[![6-security-lake-rollup-region.png](/images/2023/02/6-security-lake-rollup-region.png)](/images/2023/02/6-security-lake-rollup-region.png)
...
[![7-security-lake-storage-classes.png](/images/2023/02/7-security-lake-storage-classes.png)](/images/2023/02/7-security-lake-storage-classes.png)

Grant administration access inside Lake Formation to Security Lake for the current IAM access role.

[![8-security-lake-administrator.png](/images/2023/02/8-security-lake-administrator.png)](/images/2023/02/8-security-lake-administrator.png)

Provide access to the Security Lake data from within Lake Formation for the current IAM access role.

[![9-security-lake-data-permissions.png](/images/2023/02/9-security-lake-data-permissions.png)](/images/2023/02/9-security-lake-data-permissions.png)
...
[![10-security-lake-lambda-trigger.png](/images/2023/02/10-security-lake-lambda-trigger.png)](/images/2023/02/10-security-lake-lambda-trigger.png)
